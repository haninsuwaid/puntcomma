...
from basisfuncties import laad_json_bestand, sorteer_data

new_steam = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'json', 'new_steam.json'))

data = laad_json_bestand(new_steam)
...
#ten opzichte van de rest van de data zijn deze het minst verspreidt